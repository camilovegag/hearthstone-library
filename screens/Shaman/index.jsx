...
export const Shaman = ({ navigation }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      await axios(
        "https://us.api.blizzard.com/hearthstone/cards?locale=en_US&set=standard&class=shaman&pageSize=77&sort=manaCost%3Aasc&access_token=UScs8hhS5oMQ04YnFZ7LWu0EZBfNDS8Yn3"
      )
        .then((response) => {
