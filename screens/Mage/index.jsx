...
export const Mage = ({ navigation }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      await axios(
        "https://us.api.blizzard.com/hearthstone/cards?locale=en_US&set=standard&class=mage&pageSize=77&sort=manaCost%3Aasc&access_token=USTspIGxbiFFRQ7QLQmOAwM84KmrY80d0k"
      )
        .then((response) => {
